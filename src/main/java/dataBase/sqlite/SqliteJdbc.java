...
public class SqliteJdbc {
	...
	public void fnCreateDataBase() {
		...
		try {
			...
			c = DriverManager.getConnection("jdbc:sqlite:sqliteDb.db");
		} catch (Exception e) {
	...
	public void fnTableInsertRecords() {
		...
		try {
			...
			sql = "INSERT INTO COMPANY (ID,NAME,AGE,ADDRESS,SALARY) " + "VALUES (5, 'ron', 45, 'Mondy ', 5000.00 );";
